...
func SignTx(w *KeyPairs, tx *types.Transaction) (*types.Transaction, error) {
...
func MakeTransactOpts(w *KeyPairs, param TransactBaseParam, gasLimit int64, nonce int64) (*bind.TransactOpts, error) {
